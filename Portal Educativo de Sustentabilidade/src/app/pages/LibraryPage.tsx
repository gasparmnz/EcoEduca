...
import { FileText, Download, Search, Filter, BookOpen, Video, FileImage } from "lucide-react";
...
export function LibraryPage() {
  ...
  const resources = [
    {
      id: "1",
      title: "Guia Completo de Reciclagem Residencial",
      description: "Manual prático para implementar a reciclagem em casa",
      type: "guide",
      topic: "waste",
      format: "PDF",
      size: "2.5 MB",
    ...
    },
    {
      ...
      description: "Técnicas eficazes para reduzir o consumo de água",
      type: "video",
      topic: "water",
      format: "MP4",
      size: "45 MB",
    ...
    {
      id: "3",
      title: "Infográfico: Ciclo da Energia Solar",
      description: "Visualização do processo de geração de energia solar",
      type: "infographic",
      topic: "energy",
      format: "PNG",
      size: "1.2 MB",
    ...
    {
      id: "4",
      title: "Apostila de Compostagem",
      description: "Aprenda a fazer compostagem de resíduos orgânicos",
      type: "guide",
      topic: "waste",
      format: "PDF",
      size: "3.8 MB",
    ...
    },
    {
      ...
      description: "Documentário sobre a riqueza da fauna e flora nacional",
      type: "video",
      topic: "biodiversity",
      format: "MP4",
      size: "120 MB",
    ...
    {
      id: "6",
      title: "Energia Eólica: Infográfico Interativo",
      description: "Como funciona a geração de energia através dos ventos",
      type: "infographic",
      topic: "energy",
      format: "SVG",
      size: "800 KB",
        ...
        {filteredResources.map(resource => {
          ...
          return (
            <div key={resource.id} className="bg-white rounded-lg shadow-md p-6 hover:shadow-xl transition-shadow">
              ...
              <button className="w-full flex items-center justify-center bg-green-700 text-white px-4 py-2 rounded-lg hover:bg-green-600 transition-colors">
            ...
            .map((resource, index) => {
              ...
              return (
                <div key={resource.id} className="flex items-center justify-between p-4 border-b last:border-b-0 hover:bg-gray-50">
                  ...
                  <button className="flex items-center text-green-700 hover:text-green-600">
